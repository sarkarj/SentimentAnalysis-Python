...
Click `'ENI Id'`, this will redirect to the AWS EC2 console and show an instance running in NETWORK & SECURITY -> Network Interfaces. Grab the `'IPv4 Public IP'`  address of that instance
